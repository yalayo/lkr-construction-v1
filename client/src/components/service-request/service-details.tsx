  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        <div>
          <Label htmlFor="issue_type" className="block text-sm font-medium text-neutral-700 mb-1">
        ...
        <div>
          <Label htmlFor="urgency" className="block text-sm font-medium text-neutral-700 mb-1">
        ...
        <div>
          ...
          >
            <div className="flex items-center mr-6">
              <RadioGroupItem id="previous_yes" value="yes" className="mr-2" />
              <Label htmlFor="previous_yes" className="text-sm text-neutral-700">Yes</Label>
            </div>
            <div className="flex items-center">
              <RadioGroupItem id="previous_no" value="no" className="mr-2" />
              <Label htmlFor="previous_no" className="text-sm text-neutral-700">No</Label>
            </div>
          </RadioGroup>
        </div>
      </div>
